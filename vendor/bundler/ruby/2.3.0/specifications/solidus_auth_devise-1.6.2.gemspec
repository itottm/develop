# -*- encoding: utf-8 -*-
# stub: solidus_auth_devise 1.6.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<deface>.freeze, ["~> 1.0.0"])
      ...
      s.add_development_dependency(%q<capybara>.freeze, ["~> 2.7.1"])
      ...
      s.add_dependency(%q<deface>.freeze, ["~> 1.0.0"])
      ...
      s.add_dependency(%q<capybara>.freeze, ["~> 2.7.1"])
